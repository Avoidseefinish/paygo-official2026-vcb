...
const BuyPayId = ({
  ...
  const renderServiceNotice = () => <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg p-6 w-full max-w-md">
        ...
        <div className="border-l-4 border-orange-400 p-4 mb-4 bg-green-50">
          <div className="flex items-center space-x-2 mb-2">
            <span className="text-orange-600">✓</span>
            <h4 className="font-bold text-green-600">Opay Bank Service Down</h4>
          </div>
          <p className="text-sm text-orange-600">All other bank transfers are now working normally. You can proceed with your payment safely.</p>
        </div>
        
        <p className="text-gray-600 text-sm mb-6">We appreciate your patience. All other banks are working normally and your payment will be processed immediately.</p>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-blue-800 text-sm">onlineincomingacademy15@gmail.com</span>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between py-4 border-b border-gray-200">
                  ...
                  <div className="flex items-center space-x-3">
                    <span className="text-xl font-bold text-gray-900">9160886263</span>
                    <Button onClick={() => handleCopy('9160886263')} className="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 text-sm rounded-md">
                      Copy
                    </Button>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between py-4 border-b border-gray-200">
                  ...
                  <span className="text-xl font-bold text-gray-900">YENKAT NANSHEP</span>
                </div>
              </div>
